...
def main():
    ...
    model_name = 'models.'+cfg.MODEL.NAME+'.get_pose_net'
    ...
    input_img_name = '001226.jpg'
    input_img = '/p/home/guru/hr_net/deep-high-resolution-net.pytorch-master/demo/' + input_img_name
    output_img = '/p/home/guru/hr_net/deep-high-resolution-net.pytorch-master/demo/work/output_' + input_img_name
